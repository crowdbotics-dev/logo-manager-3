"""
Django settings for logo_manager_3 project.
...
ROOT_URLCONF = 'logo_manager_3.urls'
...
WSGI_APPLICATION = 'logo_manager_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "logo_manager_3 API",
    "DESCRIPTION": "API documentation for logo_manager_3 App",
    "VERSION": "v1",
}
